          ...
          child: PageView(
            ...
            children: <Widget>[
              _buildPageContent(
                  ...
                  body:
                  'We Got You! You dream We build it for you,'),
              _buildPageContent(
              ...
              _buildPageContent(
                  ...
                  body:
                  'You can track you project activity ')
            ],
          ),
        ),
      ),
      bottomSheet: _currentPage != 2
        ...
        child: Row(
          ...
          children: <Widget>[
            FlatButton(
              onPressed: () {
                _pageController.animateToPage(2, duration: Duration(milliseconds: 200), curve: Curves.linear);
                setState(() {});
              },
            ...
            FlatButton(
              onPressed: () {
                _pageController.animateToPage(_currentPage + 1, duration: Duration(milliseconds: 200), curve: Curves.linear);
                setState(() {});
              },
              splashColor: Colors.blue[50],
              child: Text(
